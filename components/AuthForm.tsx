...
const AuthForm = ({ type }:{ type: string }) => {
  ...
  : {
    ...
    // 2. Define a submit handler. async means to we want to send the data somewhere
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            if(response) router.push("/") // if success, then go to home page ("/")
                        ...
                        {type === "sign-up" && (
                            <>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <CustomInput 
                                        control={form.control} name="ssn" label="SSN" placeholder="Example: 123 456 789"/>
                                </div>
                            </>
                        )}
